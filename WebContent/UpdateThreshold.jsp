...
<body>
	...
	<%
		...
		try{
			...
			PreparedStatement ps=con.prepareStatement("update devices set cputhreshold=?,diskthreshold=?,memorythreshold=?");
			...
			ps.executeUpdate();
			 String redirectURL = "http://localhost:8080/AnveshakTeam2/Alarms.jsp";
